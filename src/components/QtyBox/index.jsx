...
export const QtyBox = (props) => {
    ...
    return (
        <div className='qtyBox  relative'>
            <input type='number' className='w-full h-[45px] !p-2 !pl-5 text-[15px]
        focus:outline-none border border-[rgba(0,0,0,0.2)] 
    ...
    <div className='flex items-center flex-col justify-between h-[40px]
                ...
                <Button className='!min-w-[30px]  !w-[25px] !h-[20px] !text-[#000] !rounded-none
                hover:!bg-[#f1f1f1]'
                    onClick={plusQty}>
